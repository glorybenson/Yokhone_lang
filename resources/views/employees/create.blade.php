                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('edit.employee', $employee->id) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ $employee->first_name }}" autocomplete="first name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="last_name" type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" value="{{ $employee->last_name }}" required autocomplete="last name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="employee_id" type="number" class="form-control @error('employee_id') is-invalid @enderror" name="employee_id" value="{{ $employee->employee_id }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="hiring_date" type="date" class="form-control @error('hiring_date') is-invalid @enderror" name="hiring_date" value="{{ $employee->hiring_date }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="CIN" type="text" class="form-control @error('CIN') is-invalid @enderror" name="CIN" value="{{ $employee->CIN }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="cell_1" type="text" class="form-control @error('cell_1') is-invalid @enderror" name="cell_1" value="{{ $employee->cell_1 }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address">{{ $employee->address }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="contact_full_name" type="text" class="form-control @error('contact_full_name') is-invalid @enderror" name="contact_full_name" value="{{ $employee->contact_full_name }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="contact_1_cell" type="text" class="form-control @error('contact_1_cell') is-invalid @enderror" name="contact_1_cell" value="{{ $employee->contact_1_cell }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="contact_1_cell2" type="text" class="form-control @error('contact_1_cell2') is-invalid @enderror" name="contact_1_cell2" value="{{ $employee->contact_1_cell2 }}">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('create.employee') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="CIN_proof" type="file" accept="application/pdf" class="form-control @error('CIN_proof') is-invalid @enderror" name="CIN_proof" value="{{ old('CIN_proof') }}">
