...
<div class="content container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('edit.client', $client->id) }}">
                        ...
                        <div class="row mb-3">
                            <label for="contact_full_name" class="col-md-4 col-form-label text-md-end">{{ __('Contact Full Name') }}</label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label for="date_become_client" class="col-md-4 col-form-label text-md-end">{{ __('Date Become Client') }}</label>
                            <div class="col-md-8">
                        ...
                        <div class="row mb-3">
                            <label for="referred_by" class="col-md-4 col-form-label text-md-end">{{ __('Referred By') }}</label>
                            <div class="col-md-8">
                                <select class="form-control" onchange="referred(this.value)" id="referred_by_id" name="referred_by">
                        ...
                        <div class="row">
                            <label for="employee" class="col-md-4 col-form-label text-md-end"></label>
                            <div class="col-md-8 mb-3" id="employee_div" style="display: none;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 mb-3" id="other_div" style="display: none;">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title float-left">Create Client</h4>
                    <div class="text-right">
                        <a href="{{ route('clients') }}" class="btn btn-secondary p-2">Back to Clients</a>
                    </div>
                </div>
